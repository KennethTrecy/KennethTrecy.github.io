...
const meta = defineArticlePageMeta("/articles/different_levels_of_abstraction_in_programming", {
	...
	"dateModified": new Date(Date.UTC(2023, 1, 18, 10, 15)),
	"description": "Find out different levels of abstraction in programming and their differences.",
	"keywords": [ "Abstraction", "level", "programming", "customizability", "reusability" ],
