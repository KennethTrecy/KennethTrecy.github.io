...
<ArticlePost {pageMeta}>
	<StructuredSection itemprop="about" id={introduction.id}>
		...
		<SimpleText itemprop="about">
			<strong itemprop="keywords">Centering</strong> an element is a usual task for a web developer. Images, modals, navigation anchor, and container of block of texts are the common components desired to be in the center. Semantically, Cascading Style Sheets (<abbr>CSS</abbr>) uses the word <em>center</em> to indicate that an element has equal spaces with respect to intended axis.
		</SimpleText>
		<SimpleText>
			A programmer may center a content according to its <strong itemprop="keywords">x-axis</strong> (e.g. <code>text-align: center;</code>), <strong itemprop="keywords">y-axis</strong> (e.g. <code>vertical-align: middle;</code>), or both. This article explores common ways to put an element in the center and presents a unorthodox way for a special use case.
		</SimpleText>
	</StructuredSection>
</ArticlePost>
